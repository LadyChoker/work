...
public class SEErrorFlowDescriptor extends ErrorFlowDescriptor {
	...
	/**
	 * Constructor to be used when a SE Error Flow Descriptor is received and it is wanted to decode it
	 */
